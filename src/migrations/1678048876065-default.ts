...
export class default1678048876065 implements MigrationInterface {
    name = 'default1678048876065'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "consultas" ("id" int NOT NULL IDENTITY(1,1), "nome" text NOT NULL, "dataNasc" date NOT NULL, "genero" text NOT NULL, "numeroCelular" text NOT NULL, "dataConsulta" datetime NOT NULL, "especialidade_id" int, "profissional_id" int, "unidade_id" int, CONSTRAINT "PK_889a9011f1854a60a6aae1c6d80" PRIMARY KEY ("id"))`);
