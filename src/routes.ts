...
routes.post("/consultas/:idEspecialidade/:idUnidade/:idProfissional", new ConsultaController().create);
routes.put("/consultas/:idConsulta/:idEspecialidade/:idUnidade/:idProfissional", new ConsultaController().update);
...
routes.put("/especialidades/:idEspecialidade", new EspecialidadeController().update);
routes.delete("/especialidades/:idEspecialidade", new EspecialidadeController().delete);
...
routes.post("/profissional/:idEspecialidade/:idUnidade", new ProfissionalController().create);
routes.put("/profissional/:idProfissional/:idEspecialidade/:idUnidade", new ProfissionalController().update);
routes.delete("/profissional/:idProfissional", new ProfissionalController().delete);
